  ...
  Mdate.prototype = {
    constructor: Mdate, dateBoxShow: function () {
      ...
      var str = "" + '<section class="getDateBg">' + '</section>' +
          ...
          '<h1 class="popup_title">请选择身份证有效截止日期</h1>'+
          '<div class="dateContent">' + '<div class="checkeDate"></div>' +
          '<div id="yearwrapper">' + '<ul id="yearUl"></ul>' + "</div>" +
          '<div id="monthwrapper">' + '<ul id="monthUl"></ul>' + "</div>" +
          '<div id="daywrapper">' + '<ul id="dayUl"></ul>' + "</div>" + "</div>" +
          '<div class="remarks_box"><div class="agree_box"><input type="checkbox" class="active">长期<span>(若有效期截止日期为长期，请勾选)</span></div></div>' +
