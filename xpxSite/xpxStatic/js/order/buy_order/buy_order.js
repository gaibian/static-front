...
var btmPopup = function () {
  var _queue = [];

  var popupFun = function () {
    function popupFun(el) {
      (0, _classCallCheck3.default)(this, popupFun);
    ...
    popupFun.prototype.init = function init() {
      this.bind();
    };

    popupFun.prototype.bind = function bind() {
      var _this = this;

      this.btn.on('click', function () {
        var allPopup = $('.popup_box');
        allPopup.each(function (index) {
        ...
        _this.popup.addClass('move_bottom');
      });
      this.val.each(function (index) {
        var $this = _this.val.eq(index);
        $this.on('click', function () {
          var val = $this.text();
          var dataId = $this.attr('data-id');
          var dataStatus = $this.attr('data-status');
          if (typeof dataStatus === 'undefined') {
            _this.setVal.text(val);
            _this.setVal.attr('data-id', dataId);
            _this.popup.removeClass('move_bottom');
          } else {
            _this.setVal.text(val);
            _this.setVal.attr('data-id', _this.dataId);
            _this.popup.removeClass('move_bottom');
            var sInput = _this.el.find('.s_input');
            if (dataStatus === 'true') {
              sInput.hide();
